...
import deskappIcon5 from "../../../../image/application/copilot.jpg"
import deskappIcon6 from "../../../../image/application/chatgpt.png"
...
const PanelApplication = [
    ...
    { id: 5, name: "Copilot", alt: "Copilot", icon: deskappIcon5, width: "1080px", height: "620px", maxDefault: true, ish5: true, h5url: "https://copilot.microsoft.com/",template: <ContentWindowLayout name={"Copilot"} icon={deskappIcon5} /> },
    ...
    { id: 10, name: "反馈社区", alt: "反馈社区", icon: deskappIcon11, width: "1080px", height: "620px", maxDefault: false, ish5: true, h5url: "https://win.react.yunair.cn/feeds.html",template: <ContentWindowLayout name={"反馈社区"} icon={deskappIcon11} /> },
